...
pipe.create_line(70, 0, 70, 140)
pipe.create_line(70, 70, 140, 70)
pipe.grid(row=1, column=1)

pipe = Canvas(system, width=140, height=140)
pipe.create_line(70, 0, 70, 140)
pipe.create_line(70, 70, 0, 70)
pipe.grid(row=2, column=1)

pipe = Canvas(system, width=140, height=140)
pipe.create_line(70, 0, 70, 140)
pipe.create_line(0, 70, 70, 70)
...
pipe = Canvas(system, width=140, height=140)
pipe.create_line(70, 0, 70, 70)
pipe.create_line(70, 70, 0, 70)
pipe.grid(row=4, column=10)

pipe = Canvas(system, width=140, height=140)
pipe.create_line(0, 70, 140, 70)
...
pipe = Canvas(system, width=140, height=140)
pipe.create_line(140, 70, 70, 70)
pipe.create_line(70, 70, 70, 0)
